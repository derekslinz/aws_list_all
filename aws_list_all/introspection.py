...
# Additional services that are either deprecated, have specialized endpoints, or otherwise
# should be ignored for the purposes of introspection on typical accounts. These were
# added to keep the packaged service lists in sync with boto3/DNS introspection.
SERVICE_IGNORE_LIST.extend([
    'aiops',
    'application-signals',
    'arc-region-switch',
    'artifact',
